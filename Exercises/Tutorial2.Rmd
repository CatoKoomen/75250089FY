...
str(oxis_df[, vars])
# here we see that the variable labels are saved as "label. By using the function "attr()", we can access the attribute of interest of the variables.
...
#the above code basically calls the third and fourth levels, i.e. levels(oxis_df$education)[c(3,4)]<- "More than secondary"
...
mean_accmo_trgov <- tapply(oxis_df$accmo, oxis_df$trgov, mean, na.rm = TRUE)
