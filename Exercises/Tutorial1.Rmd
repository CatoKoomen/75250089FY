...
8. Would it be possible to create a data frame by combining the three vectors you created in steps 1, 2 and 4? Try it out and see what happens. Note that the vector you created in step 1 has a different length than the vectors in steps 2 and 4.
```{r}
